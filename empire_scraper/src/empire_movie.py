...
from empire_scraper.src.empire_helpers import requests_get, get_proxies
from datetime import datetime
import os


class EmpireMovie(object):
    def __init__(self, logger, info=None, process_images=True, use_proxies=True, max_number_of_attempts=5):
        self.logger = logger
        self.info = info
        self.info_id = None
